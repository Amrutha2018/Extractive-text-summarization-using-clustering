...
#-----------------------------------------------------------------------------#
path_to_models = '/content/data/models/'
path_to_tables = '/content/data/tables/'
#-----------------------------------------------------------------------------#
...
def load_tables():
    ...
    utable = numpy.load(path_to_utable, allow_pickle=True,  encoding='latin1')
    btable = numpy.load(path_to_btable, allow_pickle=True,  encoding='latin1')
